...
export const createBooking = async (req, res) => {
  ...
  try {
    ...
    if (!settings)throw new Error("System commission settings not configured. Please contact your administrator to set up the required parameters before proceeding.");
